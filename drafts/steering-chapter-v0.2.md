# Steering — Chapter v0.2 (discovery draft)

**Status:** One revision pass after Cycle 1 pressure test. Still not publication-ready.  
**Changes from v0.1:** Tomato beat shortened; "only one observer"; signature lines flagged.  
**Constitution:** `docs/seeing-food-differently-guide-constitution.md`  
**Shape:** `docs/seeing-food-differently-steering-discovery-board.md` § Shape Session v0.1

---

## v0.2 editor notes (remove before publish)

**Cycle 1 verdict (Rajiv):** Pass. Strongest chapter after Flavor by *educational experience* (not prose). **Rest at v0.2** unless blocker. Editorial refinement only; no discovery cycle.

**Distinctive level:** Thinking while cooking, not cooking instruction. Deepest insight: steering teaches readers to **stay with food**, not fix food.

**Signature lines (protect):** "A recipe has a last step. A dish does not always have a last moment." · "If you only taste at the end, you are grading a journey you did not watch." · "Finishing is part of cooking, not dressing up something already perfect." · ingredients present → dish ready.

**Revision watches:** Bitter melon vs Heat overlap (timing) · "What you are not doing" works here; do not overuse section type across chapters.  
**Cross-chapter pass:** Mother/professor spoon ownership → Flavor. Steering replacement: early dal taste as progress report (truth-test).

**Verb (working):** steer. Response sometimes = wait.  
**Try tonight:** Option A primary; Option B secondary.
...
## Pressure-test checklist (Rajiv + GPT)

- [x] Realization before advice rhythm?
- [x] Not collapsed to tips chapter?
- [x] Distinct from Heat and Flavor?
- [x] Five conversations; cheese lab weave?
- [x] Passive steering; response = wait?
- [x] Cycle 1 pass; editorial refinement only?
- [ ] Bitter melon / Heat overlap watch (future revision)
- [ ] Surface title TBD

**Cycle 1 verdict:** Rest at v0.2. Core curriculum complete at five territories; pause before new chapters.
